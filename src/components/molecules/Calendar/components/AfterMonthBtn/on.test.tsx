...
import { AfterMonthBtn } from './index';

type ElementProps = ComponentPropsWithoutRef<typeof AfterMonthBtn>;
...
const buildComponent = ({
    ...
    return (
        <AfterMonthBtn btnHandler={btnHandler} label={label}>
            {children}
        </AfterMonthBtn>
    );
};

describe('<AfterMonthBtn /> component', () => {
